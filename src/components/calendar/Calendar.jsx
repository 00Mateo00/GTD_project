...
export const Calendar = () => {
	const { monthIndex, onShowModal, selectedCalendarEvent, setSelectedCalendarEvent, dispatchCallCalendarEvent } = useContext(GlobalContext);
	...
	return (
		<main>
				...
				<div className="calendar-body flex flex-col">
					<div className="calendar__div flex flex-1">
						<div className="days-month-wrapper">
							...
							<div className={`flex-1 grid  grid-rows-${numberOfRow} month-wrapper`}>{monthTable}</div>
						</div>
					</div>
				</div>
			...
			<section className="dayViewFrame">
				<DayView />
			</section>
		</main>
	);
