...
export const Day = ({ day }) => {
	...
	const { ModalParams, setDaySelected, setOnShowModal, setShowDayView, filteredTicklerFileEvents, setSelectedTicklerFileEvent, dispatchCallTicklerFileEvent, handleChecked } =
